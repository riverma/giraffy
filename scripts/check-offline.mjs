// Giraffy must work with the radio off, forever (spec §7). Nothing in the build may
...
const ALLOWED_LINKS = [
  'https://giraffy.riverma.com',
  'https://www.gnu.org/licenses/agpl-3.0.html',
  'https://w3id.org/gnvc/1.0',
  'https://riverma.com/gnvc/',
  'https://github.com/riverma/giraffy',
